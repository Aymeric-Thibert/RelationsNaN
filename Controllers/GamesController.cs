...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        {
            var game = await _context.Game.Include(g => g.Platforms).FirstOrDefaultAsync(g => g.Id == gameId);
        ...
        public async Task<IActionResult> RemovePlatform(int gameId, int platformId)
        {
            ...
            var platform = await _context.Platform.FirstOrDefaultAsync(g => g.Id == platformId);
            if (platform == null) return NotFound();
